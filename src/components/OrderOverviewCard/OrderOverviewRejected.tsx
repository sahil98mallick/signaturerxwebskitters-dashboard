...
import { RejectedPrescriptionData } from "typescript/interface/order_overview_table.interface";
import CustomButtonPrimary from "ui/CustomButtons/CustomButtonPrimary";
import ClockIcon from "ui/Icons/ClockIcon";
import CrossIcon from "ui/Icons/CrossIcon";

const OrderOverviewRejectedCard = ({
  prescription_id,
  patient_details,
  medicine_details,
  total,
              ...
              <TableRow>
                <TableCell>
                  <Box className="rejected">
                    <CrossIcon IconColor={primaryColors.textDanger} />
...
export default OrderOverviewRejectedCard;
