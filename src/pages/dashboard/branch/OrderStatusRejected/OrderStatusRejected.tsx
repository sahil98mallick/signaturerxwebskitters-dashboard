...
import { OrderStatusRejectedrows } from "json/mock/OrderDetailAccepted.mock";
import { OrderStatusRejectedWrapper } from "styles/StyledComponents/OrderStatusRejectedWrapper";
        ...
        <OrderDetailPendingHeader>
          <Box className="orderdetailpendingbox">
            <List>
              ...
              <ListItem>
                <Box className="pendingstatusHeaderWrapper activeStatusRejected">
                  <i>
                    <img src={assest.check_red} alt="statusicon" />
                  </i>
                  <Typography variant="body1">
                    Rejected at 23/07/2023, 05.30
                  </Typography>
                </Box>
              </ListItem>
            </List>
        ...
        <Box className="body_layout">
          ...
          <Box className="tablesectionBox">
            <CommonTable>
              ...
              <TableBody>
                {OrderStatusRejectedrows.map((row) => (
            ...
            <Box className="tablesectionTotalPrice">
              <Typography variant="body1">
                ...
                <Typography variant="caption">
                  £{RowSumCalculate(OrderStatusRejectedrows)}
                </Typography>
              </Typography>
            </Box>
          </Box>
...
export default OrderStatusRejected;
